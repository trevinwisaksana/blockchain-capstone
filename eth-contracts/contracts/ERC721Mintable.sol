...
contract ERC721 is Pausable, ERC165 {
    ...
    function balanceOf(address owner) public view onlyValidAddress(owner) returns (uint256) {
...
//    @dev Approves another address to transfer the given token ID
    function approve(address to, uint256 tokenId) public {
        ...
        require(to != owner, "Cannot transfer to the same owner");
    ...
    // TIP: remember the functions to use for Counters. you can refresh yourself with the link above
    function _mint(address to, uint256 tokenId) onlyValidAddress(to) internal {
    ...
    // TIP: remember the functions to use for Counters. you can refresh yourself with the link above
    function _transferFrom(address from, address to, uint256 tokenId) onlyValidAddress(from) internal {
        // TODO: require from address is the owner of the given token
        require(ownerOf(tokenId) == from, "The sender is not the owner of the token");
